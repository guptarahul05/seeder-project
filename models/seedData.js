...
db.sync({
  ...
  Promise.all(queryArray).then(resultsAll => {
    resultsAll.forEach((resultsOfOne, index) => {
      console.log(`Table ${index + 1} insertion started`);
      resultsOfOne.forEach(resultOfOne => {
        console.log(
          '============================================\n',
          resultOfOne.toJSON(),
          '\n============================================\n'
      ...
      console.log(`Table ${index + 1} insertion complete`);
    });
